...
constinit const ZombieDefinition gZombieDefs[NUM_ZOMBIE_TYPES] = {
	...
	{ .mZombieType = ZOMBIE_POLEVAULTER, .mReanimationType = REANIM_POLEVAULTER, .mZombieValue = 1, .mStartingLevel = 6, .mFirstAllowedWave = 5, .mPickWeight = 3000, .mZombieName = "POLE_VAULTING_ZOMBIE" },
	{ .mZombieType = ZOMBIE_PAIL, .mReanimationType = REANIM_ZOMBIE, .mZombieValue = 2, .mStartingLevel = 8, .mFirstAllowedWave = 1, .mPickWeight = 3000, .mZombieName = "BUCKETHEAD_ZOMBIE" },
