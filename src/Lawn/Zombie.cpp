...
constinit const ZombieDefinition gZombieDefs[NUM_ZOMBIE_TYPES] = {
	...
	{ .mZombieType = ZOMBIE_TRAFFIC_CONE, .mReanimationType = REANIM_ZOMBIE, .mZombieValue = 1, .mStartingLevel = 3, .mFirstAllowedWave = 1, .mPickWeight = 4000, .mZombieName = "CONEHEAD_ZOMBIE" },
	{ .mZombieType = ZOMBIE_POLEVAULTER, .mReanimationType = REANIM_POLEVAULTER, .mZombieValue = 1, .mStartingLevel = 6, .mFirstAllowedWave = 3, .mPickWeight = 3000, .mZombieName = "POLE_VAULTING_ZOMBIE" },
	{ .mZombieType = ZOMBIE_PAIL, .mReanimationType = REANIM_ZOMBIE, .mZombieValue = 2, .mStartingLevel = 8, .mFirstAllowedWave = 5, .mPickWeight = 3000, .mZombieName = "BUCKETHEAD_ZOMBIE" },
	{ .mZombieType = ZOMBIE_NEWSPAPER, .mReanimationType = REANIM_ZOMBIE_NEWSPAPER, .mZombieValue = 1, .mStartingLevel = 11, .mFirstAllowedWave = 1, .mPickWeight = 3000, .mZombieName = "NEWSPAPER_ZOMBIE" },
	{ .mZombieType = ZOMBIE_DOOR, .mReanimationType = REANIM_ZOMBIE, .mZombieValue = 2, .mStartingLevel = 13, .mFirstAllowedWave = 3, .mPickWeight = 2500, .mZombieName = "SCREEN_DOOR_ZOMBIE" },
